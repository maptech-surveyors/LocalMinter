...
(function($) {
    ...
    function storeLocation(address) {
        ...
        // This re-encodes to UTF-8 and passes it as base64, so we
        // can be very clear on how the location data is represented
        writeCookie("location", Base64.encode(address.locationString), 30);
